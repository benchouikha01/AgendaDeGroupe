...
public class CreationMapping {
	...
	public boolean controlerFormulaire() {
		...
		utilisateur = UtilisateurDAO.findUserByMail(mailCreation.getText());
	...
	public void creerCompte(ActionEvent event) throws IOException {
		Utilisateur user = new Utilisateur(mailCreation.getText(), nomCreation.getText(), prenomCreation.getText(), passwordCreation.getText());
		UtilisateurDAO userDAO = new UtilisateurDAO(ConnectionFactory.getInstance());
		userDAO.create(user);
